...
print("""
INPUT DATA TYPE:
    raw data (abs_sys_corr) = 0
    normalized data (t0_norm_sys_corr) = 1""")
...
def hierarchical_cluster_correlation_heatmap(selected_reporter, sort1, sort2):
...
for reporter in reporter_list:
    hierarchical_cluster_correlation_heatmap(reporter, mscarlet_reporter, mscarlet_reporter)
